/**
 * 심리도식 검사 블로그 1편 + 섹션별 이미지 생성/게시.
 * 사용: cd functions && GOOGLE_GENAI_API_KEY=... npx tsx scripts/create-schema-blog.ts
 */
...
const SLUG = "schema-therapy-early-maladaptive-schemas-guide";
const TITLE = "심리도식 검사로 마음의 무늬 읽기: 초기부적응도식과 다섯 영역 이야기";
const CATEGORY = "성격";
const BODY = readFileSync(join(__dirname, "schema-blog-body.md"), "utf-8");
